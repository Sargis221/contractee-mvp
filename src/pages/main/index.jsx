        ...
        <div className="L-main">
            ...
            <h1 className="L-main-headline">Our top features</h1>
                <div className="L-main-feat1">
                    ...
                    <div>
                        <p className="L-main-feat-t" data-aos="fade-left">Integrated with ChatGPT, our risk assessment feature delivers insights into contract risks. ChatGPT engages in real-time discussions, providing a summary of the most critical risk factors associated with the contract. </p>
                        </div>
                </div>
                <div className="L-main-feat1">
                    
                    <div>
                        <p className="L-main-feat-t" data-aos="fade-right">Our assigning feature transforms contract management by identifying operational, financial, legal, and technical clauses in the contract. Contracts are assigned to the relevant departments, ensuring a streamlined workflow. </p>
                        </div>
                ...
                <div className="L-main-feat1">
                    ...
                    <div>
                        <p className="L-main-feat-t" data-aos="fade-left">Our drafting feature offers personalised suggestions on how to continue drafting the contract. Leveraging advanced algorithms, it analyzes context, legal nuances, and industry standards to provide intelligent recommendations, enhancing the drafting process.</p>
                        </div>
                </div>
